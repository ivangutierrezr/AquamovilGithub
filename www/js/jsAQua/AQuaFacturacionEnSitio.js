...
function liquidacionFactura(Consumo,Aseo,Uso,Categoria,IdUsuario,NumeroCuentasAcueducto,NumeroCuentasAlcantarillado,NumeroCuentasAseo,Edad)
{
	...
	document.getElementById('AcumuladosAnterioresAcueducto').value = 0;
	document.getElementById('AcumuladosAnterioresAlcantarillado').value = 0;
	document.getElementById('AcumuladosAnterioresAseo').value = 0;

	var limiteSuperiorBasico = parseInt(document.getElementById('limiteSuperiorBasico').value);
	var limiteSuperiorComplementario = parseInt(document.getElementById('limiteSuperiorComplementario').value);

	var EdadAcueducto = Edad;

	if (consumo <= limiteSuperiorBasico) 
	{
	...
	if (consumo > limiteSuperiorBasico && consumo <= limiteSuperiorComplementario) 
	{
		consumoBasico = limiteSuperiorBasico;
		consumoComplementario = parseInt(consumo) - limiteSuperiorBasico;
		consumoSuntuario = 0;
	}
...
function liquidarIntereses(Acumulado)
{
	...
	if (AcumuladosAnterioresAlcantarillado > 0) 
	{
		...
		var mensajeAlcantarillado = "<li id='listaFact"+IdAlcantarillado+"'><div class='row'><div class='col col-10' align='center'>"+idCargoAlcantarillado+"</div><div class='liquidacion col col-20' align='center'>"+TarifaAlcantarillado2+"</div><div class='liquidacion col' align='right'>"+AcumuladosAnterioresAlcantarillado.toFixed(2)+"</div><div class='liquidacion col' align='right'>"+liquidacionInteresAlcantarillado2+"</div>";
	...
	if (AcumuladosAnterioresAseo > 0) 
	{
		...
		var mensaje = "<li id='listaFact"+IdAseo+"'><div class='row'><div class='col col-10' align='center'>"+idCargoAseo+"</div><div class='liquidacion col col-20' align='center'>"+TarifaAseo2+"</div><div class='liquidacion col' align='right'>"+AcumuladosAnterioresAseo.toFixed(2)+"</div><div class='liquidacion col' align='right'>"+liquidacionInteresAseo2+"</div>";
	...
	{ 	
		...
		function(tx,result)
		{
			if (result.rows.length > 0) 
			{
				...
				if (idCargo == 1 || idCargo == 2 || idCargo == 3 || idCargo == 4) 
				{
					sumarAcumuladosAnterioresAcueducto(valorAcumulado);
				}

				if (idCargo == 5 || idCargo == 6 || idCargo == 7 || idCargo == 8) 
				{
					sumarAcumuladosAnterioresAlcantarillado(valorAcumulado);
				}

				if (idCargo == 9 || idCargo == 10) 
				{
					sumarAcumuladosAnterioresAseo(valorAcumulado);
				}
			}
...
function sumarAcumuladosAnterioresAcueducto(valor)
{
	var num = valor;
	var acumulado = parseFloat(document.getElementById('AcumuladosAnterioresAcueducto').value);
	var suma = num + acumulado;
	document.getElementById('AcumuladosAnterioresAcueducto').value = suma;
}

function sumarAcumuladosAnterioresAlcantarillado(valor)
{
	var num = valor;
	var acumulado = parseFloat(document.getElementById('AcumuladosAnterioresAlcantarillado').value);
	var suma = num + acumulado;
	document.getElementById('AcumuladosAnterioresAlcantarillado').value = suma;
}

function sumarAcumuladosAnterioresAseo(valor)
{
	var num = valor;
	var acumulado = parseFloat(document.getElementById('AcumuladosAnterioresAseo').value);
	var suma = num + acumulado;
	document.getElementById('AcumuladosAnterioresAseo').value = suma;
}
...
function cargarPieDePagina(AcumuladosAnteriores,AcumuladosIntereses)
{
	...
	var acumuladosIntereses = AcumuladosIntereses;

	var totalAPagarPresente = AsubTotalPresente + AtotalSubsidiosAportes + acumuladosIntereses;
	var AtotalAPagar = totalAPagarPresente + subTotalAcumuladosAnteriores;
	var AtotalAPagar2 = parseFloat(AtotalAPagar).toFixed(2);
	var stringTotalAPagar = AtotalAPagar2+""

	var textoLiquidacion = document.getElementById("detalleLiquidacionFactura");
	var textoDescripcionCargos = document.getElementById("descripcionCargos");

	var largo = stringTotalAPagar.length;
	var trozo1 = stringTotalAPagar.substr(-5,5);
	var largo1 = largo-5;
	var trozo2 = stringTotalAPagar.substr(0,largo1);
	var nuevoNumeroParte2 = parseInt(trozo2);
	var nuevoNumero = parseFloat(trozo1);
	var primerNumero;
	var primeraParte;
	var segundaParte;
	var parteCompleta;
	...
	if(nuevoNumero >= 50)
	{
	  ...
	  NumeroFinal = parseFloat(parteCompleta).toFixed(2);
	}
	...
	var diferencia = NumeroFinal - AtotalAPagar2;
	var nuevaDiferencia;
	var textoNuevaDiferencia;

	if (diferencia < 0) 
	{
		nuevaDiferencia = parseFloat(diferencia * (-1)).toFixed(2);
		textoNuevaDiferencia = "(" + nuevaDiferencia + ")";
	}

	else
	{
		textoNuevaDiferencia = diferencia.toFixed(2);
	}
	...
	var mensajeTotalAPagar = "<li><b><div class='row totalAPagar'><div class='col col-50'>TOTAL A PAGAR:</div><div class='col' align='right'>$ "+NumeroTotal+"</div></div></b></li>";
...
function setNumeroFactura()
{
	...
	{ 	
		...
		function(tx,result)
		{
			var noFactura = result.rows.item(0)['UltimoNoFactura'];
			...
			nuevoValor8 = 8,
			nuevoValor9 = 9,
			nuevaCadena = trozo1.replace(patron0, nuevoValor0),
			nuevaCadena = trozo1.replace(patron1, nuevoValor1),
			nuevaCadena = trozo1.replace(patron2, nuevoValor2),
			nuevaCadena = trozo1.replace(patron3, nuevoValor3),
			nuevaCadena = trozo1.replace(patron4, nuevoValor4),
			nuevaCadena = trozo1.replace(patron5, nuevoValor5),
			nuevaCadena = trozo1.replace(patron6, nuevoValor6),
			nuevaCadena = trozo1.replace(patron7, nuevoValor7),
			nuevaCadena = trozo1.replace(patron8, nuevoValor8),
			nuevaCadena = trozo1.replace(patron9, nuevoValor9);
			//
			var largo1 = largo-7;
			//
			var trozo2 = noFactura.substr(0,largo1);
			//
			var nuevoNum = parseFloat(nuevaCadena);
			var nuevoNumero = nuevoNum+1;
			//
			//
