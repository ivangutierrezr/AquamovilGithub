...
function onPhotoURISuccessCatastro(imageURI) 
{
	var gotFileEntry = function(fileEntry) 
	{
		...
		var gotFileSystem = function(fileSystem) 
		{
			fileSystem.root.getDirectory("AQuaMovil/Salidas/Fotos", {create : true, exclusive: false}, function(dataDir) 
			{
				...
				console.log("Imagen Guardada"+ newFileName + dataDir);
...
function FotoCatastro() 
{
	// Take picture using device camera and retrieve image as base64-encoded string
	navigator.camera.getPicture(onPhotoURISuccessCatastro, onFail, { quality: 50,
...
function onPhotoURISuccessCatastroEditar(imageURI) 
{
	var gotFileEntry = function(fileEntry) 
	{
		//alert(“got image file entry: ” + fileEntry.fullPath);
...
function FotoCatastroEditar() 
{
	// Take picture using device camera and retrieve image as base64-encoded string
	navigator.camera.getPicture(onPhotoURISuccessCatastroEditar, onFail, { quality: 50,
	destinationType: Camera.DestinationType.FILE_URI, cameraDirection: Camera.Direction.BACK });
}
